...
from custom_components.bluetti_bt.bluetti_bt_lib.devices.el100v2 import EL100V2
...
class TestDeviceBuilder(unittest.TestCase):
    ...
    def test_build_EL100V2(self):
        bt_addr = "aa:bb:cc:dd:ee:ff"
        bt_name = "EL100V256786746478"
        built = build_device(bt_addr, bt_name)

        self.assertIsInstance(built, EL100V2)
        self.assertEqual(built.address, bt_addr)
